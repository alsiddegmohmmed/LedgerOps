import { promoteReconciliationRun } from "../../../../../lib/core";
import {
...
export async function POST(
  ...
  const result = await promoteReconciliationRun(
    access.session.selectedTenantId!, runId, access.session.accessToken,
    { batchFamilyId, confirmation: true, reason },
  );
  return mapCredentialActionResponse(result, 200, "reconciliation_promotion_failed");
}
