...
| 0.2 | Distributed processing with Kafka, transactional outbox, and idempotent consumers | Active — Slices 0–5 complete |
...
Current implemented stack through Release 0.2 Slice 5:
...
The approved technology baseline is documented in the [Technical Design and Architecture Specification](docs/architecture/LedgerOps_Technical_Design_and_Architecture_Specification_v1.6.docx). Technologies are introduced only by their implementation slice. Slice 5 adds bounded recovery scheduling and the acyclic retry-command flow without adding a new platform technology. Signed webhook reception begins in Slice 6.
