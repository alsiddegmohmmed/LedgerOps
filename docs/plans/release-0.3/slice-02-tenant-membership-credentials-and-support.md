...
- Incomplete: Authenticated Playwright coverage for credential creation, rotation, revocation, one-time secret handling, and error recovery; membership/Merchant/configuration UI; explicit support session and UI indicator; and audit search remain. Slice 2 is not complete.
- Deviations: None
